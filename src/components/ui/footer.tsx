    ...
    <footer className="bg-black border-t border-white/10 text-neutral-400">
      <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row justify-between items-center gap-4">
        ...
        <div className="text-center sm:text-left">
          <p className="text-sm font-semibold text-neutral-300">ICRAC 2026</p>
        ...
        <nav className="flex flex-wrap items-center justify-center sm:justify-end gap-x-6 gap-y-2 text-sm font-medium">
          <Link to="/callforpapers" className="hover:text-white transition-colors">
            Call for Papers
          </Link>
          <Link to="/committees" className="hover:text-white transition-colors">
            Committees
          </Link>
          <Link to="/submission" className="hover:text-white transition-colors">
            Publication
          </Link>
