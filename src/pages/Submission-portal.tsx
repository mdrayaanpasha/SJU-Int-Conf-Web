...
// 1. NAVBAR (Submit Button Removed)
...
export default function SubmissionPage() {
  ...
  return (
    <div className="min-h-screen bg-neutral-50 font-sans text-neutral-900">
      ...
      {/* Navbar with logic passed down */}
      <Navbar isOpen={isOpen} onToggle={toggleMenu} scrolled={scrolled} />

      <main className="pt-24 pb-32 overflow-hidden">
        {/* Background Decor */}
        <div className="fixed top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-neutral-300 to-transparent" />
        <div className="fixed right-0 top-1/4 w-96 h-96 bg-blue-500/5 rounded-full blur-3xl -z-10" />
        <div className="fixed left-0 bottom-1/4 w-96 h-96 bg-purple-500/5 rounded-full blur-3xl -z-10" />

        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          
          {/* 1. THE BIG ACKNOWLEDGMENT BANNER */}
